...
<head>
<meta charset="utf-8">
<title>E-Recruitment Portal / <?php echo $title;?></title>
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Contact No. (+91)7798787984</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">E-Recruitment Portal System<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          <address>
          <strong>Prime Search</strong><br>
         Pimple Gurav<br>
           Pune , Maharashtra</address>
          <p>
            <i class="icon-phone"></i> (+91) 7798787984<br>
            <i class="icon-envelope-alt"></i> pratiksha10301@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
